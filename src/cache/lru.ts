...
interface Cache {
    ...
    get(key: any): any,
    del(keys: any|any[]): any,
    delete(keys: any|any[]): any,
    reset(): void,
    clear(): void,
    getUnCachedKeys(keys: any[], cachedData: any) : any,
    dump(): any[],
    peek(key: any, opts?: { allowStale?: boolean }): any,
}
